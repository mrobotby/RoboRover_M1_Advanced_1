...
void loop() {
     ...
     // Программа по включению пьезоэлектрического звонка, который подключен к цифровому выводу D6 и проигрывания Имперского марша.
  ...
  // 2. Звонок начнет проигрывать мелодию.
